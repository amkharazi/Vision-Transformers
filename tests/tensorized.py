...
if __name__ == '__main__':
    ...
    parser.add_argument('--ignore_modes', type=int, nargs='+', default=[0, 1, 2],
                        help='Tuple of modes to ignore (default: (0,1,2))')
    parser.add_argument('--tensor_method_mlp', type=str, nargs='+', default=['tle', 'tle'],
                        help='Tensor method for MLP layers (default: ("tle", "tle"))')
    parser.add_argument('--tensor_method', type=str, default='tle',
                        help='Tensor method (default: "tle")')
    parser.add_argument('--tdle_level', type=int, default=3,
                        help='TDLE level (default: 3)')
    parser.add_argument('--reduce_level', type=int, nargs='+', default=[0, 0, 0],
                        help='Tuple of reduction levels (default: (0,0,0))')
    ...
    main(dataset=args.dataset,
         ...
         ignore_modes=tuple(args.ignore_modes),
         tensor_method_mlp=tuple(args.tensor_method_mlp),
         tensor_method=args.tensor_method,
         tdle_level=args.tdle_level,
         reduce_level=tuple(args.reduce_level),
