...
def get_tinyimagenet_dataloaders(data_dir='../datasets', transform_train=None, transform_val=None, transform_test=None, batch_size=64, image_size=192, train_size='default', repeat_count=3):
    ...
    repeated_train_dataset = ConcatDataset([dataset_train] * repeat_count)
...
# Example usage:
# train_loader, val_loader, test_loader = get_tinyimagenet_dataloaders(data_dir='./dataset', image_size=192)
