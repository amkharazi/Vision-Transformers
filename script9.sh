...
# python train.py --run_id EXPID001_vit_small_tensorized_test_mnist --model_type tensorized --dataset mnist --batch_size 64 --epochs 200 --image_size 224 --patch_size 16 --num_classes 10 --num_layers 12 --num_heads 3 2 2 --embed_dim 3 16 16 --mlp_dim 3 32 32 --tensor_method_mlp tle tp --tensor_method tle
...
# python train.py --run_id EXPID002_vit_small_tensorized_test_cifar10 --model_type tensorized --dataset cifar10 --batch_size 64 --epochs 200 --image_size 224 --patch_size 16 --num_classes 10 --num_layers 12 --num_heads 3 2 2 --embed_dim 3 16 16 --mlp_dim 3 32 32 --tensor_method_mlp tle tp --tensor_method tle
...
# python train.py --run_id EXPID003_vit_small_tensorized_test_cifar100 --model_type tensorized --dataset cifar100 --batch_size 64 --epochs 200 --image_size 224 --patch_size 16 --num_classes 100 --num_layers 12 --num_heads 3 2 2 --embed_dim 3 16 16 --mlp_dim 3 32 32 --tensor_method_mlp tle tp --tensor_method tle
...
# python train.py --run_id EXPID004_vit_small_tensorized_test_tinyimagenet --model_type tensorized --dataset tinyimagenet --batch_size 64 --epochs 200 --image_size 224 --patch_size 16 --num_classes 200 --num_layers 12 --num_heads 3 2 2 --embed_dim 3 16 16 --mlp_dim 3 32 32 --tensor_method_mlp tle tp --tensor_method tle
...
# python train.py --run_id EXPID005_vit_small_tensorized_test_fashionmnist --model_type tensorized --dataset fashionmnist --batch_size 64 --epochs 200 --image_size 224 --patch_size 16 --num_classes 10 --num_layers 12 --num_heads 3 2 2 --embed_dim 3 16 16 --mlp_dim 3 32 32 --tensor_method_mlp tle tp --tensor_method tle
...
# python train.py --run_id EXPID006_vit_small_tensorized_test_flowers102 --model_type tensorized --dataset flowers102 --batch_size 64 --epochs 200 --image_size 224 --patch_size 16 --num_classes 102 --num_layers 12 --num_heads 3 2 2 --embed_dim 3 16 16 --mlp_dim 3 32 32 --tensor_method_mlp tle tp --tensor_method tle
...
# python train.py --run_id EXPID007_vit_small_tensorized_test_oxford_pets --model_type tensorized --dataset oxford_pets --batch_size 64 --epochs 200 --image_size 224 --patch_size 16 --num_classes 37 --num_layers 12 --num_heads 3 2 2 --embed_dim 3 16 16 --mlp_dim 3 32 32 --tensor_method_mlp tle tp --tensor_method tle
...
# python train.py --run_id EXPID008_vit_small_tensorized_test_stl10 --model_type tensorized --dataset stl10 --batch_size 64 --epochs 200 --image_size 224 --patch_size 16 --num_classes 10 --num_layers 12 --num_heads 3 2 2 --embed_dim 3 16 16 --mlp_dim 3 32 32 --tensor_method_mlp tle tp --tensor_method tle
