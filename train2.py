...
def build_model(
    ...
    if model_type == "pretrained":
        ...
        model = VisionTransformer(
            num_classes=num_classes, pretrained=True, freeze_encoder=False
        )
...
def get_train_loader(
    dataset: str, data_root: str, batch_size: int, image_size: int, train_size: str
):
    if dataset == "cifar10":
        ...
        loader, _ = get_cifar10_dataloaders(
            data_root,
            transform_train,
            transform_test,
            batch_size,
    ...
    if dataset == "cifar100":
        ...
        loader, _ = get_cifar100_dataloaders(
            data_root,
            transform_train,
            transform_test,
            batch_size,
    ...
    if dataset == "mnist":
        ...
        loader, _ = get_mnist_dataloaders(
            data_root,
            transform_train,
            transform_test,
            batch_size,
    ...
    if dataset == "tinyimagenet":
        ...
        loader, _ = get_tinyimagenet_dataloaders(
            data_root,
            transform_train,
            transform_val,
            transform_val,
    ...
    if dataset == "fashionmnist":
        ...
        loader, _ = get_fashionmnist_dataloaders(
            data_root,
            transform_train,
            transform_test,
            batch_size,
    ...
    if dataset == "flowers102":
        ...
        loader, _ = get_flowers102_dataloaders(
            data_root,
            transform_train,
            transform_test,
            batch_size,
    ...
    if dataset == "oxford_pets":
        ...
        loader, _ = get_oxford_pets_dataloaders(
            data_root,
            transform_train,
            transform_test,
            batch_size,
    ...
    if dataset == "stl10":
        ...
        loader, _ = get_stl10_classification_dataloaders(
            data_root,
            transform_train,
            transform_test,
            batch_size,
...
def main():
    ...
    p.add_argument(
        ...
        type=str,
        default="pretrained",
        choices=["pretrained", "tensorized", "original"],
    )
    ...
    p.add_argument(
        "--tensor_method", type=str, default="tle", choices=["tle", "tdle", "tp"]
    )
    ...
    train_loader = get_train_loader(
        args.dataset, args.data_root, args.batch_size, args.image_size, args.train_size
    )

    img_shape = (args.batch_size, 3, args.image_size, args.image_size)
    tensor_kwargs = vars(args)
    model = build_model(args.model_type, args.num_classes, tensor_kwargs, img_shape).to(
        device
    )
