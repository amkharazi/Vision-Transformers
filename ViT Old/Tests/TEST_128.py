...
# Test SWIN Tiny model on CIFAR-100  dataset
# Optimizer Adam
# CIFAR-100 dataset -> (3, 224, 224) 
########################################################
...
if __name__ == '__main__':
    ...
    # Load the CvT model without pretrained weights
    model = timm.create_model('swin_tiny_patch4_window7_224', pretrained=False, num_classes=10).to(device)
